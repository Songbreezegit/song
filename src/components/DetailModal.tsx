...
interface DetailModalProps { item: Article | Project | null; onClose: () => void; pending?: boolean; loading?: boolean; error?: Error | null; onRetry?: () => void }
export function DetailModal({ item, onClose, pending = false, loading = false, error = null, onRetry }: DetailModalProps) {
 ...
 const project = item && 'features' in item ? item : null;
